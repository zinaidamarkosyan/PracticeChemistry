...
export const tur_Text: TurTextType = [
  ...
  [ // 7
    `This is the second order reaction you created earlier.`,
  ...
  [ // 8
    (val: string[]) => `This is the second order reaction you created earlier, which has a fixed rate constant of ${val[0]}.`,
    `<span>Try dragging the time indicator to scrub through the reaction time.</span>`,
    `Swipe left or press next to see another reaction type.`,
  ],
  [ // 9
